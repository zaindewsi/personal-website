...
image: ./image.png
banner: ./banner.png
description: Tweeter is a single-page app that lets you share your thoughts in 140 chracters or less.
---

## <a className="live-site" href="https://tweeter-zaindewsi.herokuapp.com/" target="_blank">LIVE DEMO</a> | <a className="live-site" href="https://github.com/zaindewsi/tweeter">Github Repo</a>

<p className="text-primary">
    ** Please be respectful as your tweets will be visible to anyone who views
    the website! **
</p>

Tweeter is a single-page Twitter clone that allows you to share your thoughts in 140 characters or less.
...
!["Home page on mobile](/images/mobile-home.png)
